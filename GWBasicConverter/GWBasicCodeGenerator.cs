...
public partial class GWBasicCodeGenerator
{
    public const byte MagicByte = 0xff;
    public static readonly Dictionary<int, string> Tokens = new()
    {
        [0x81] = "END",
        [0x82] = "FOR",
        [0x83] = "NEXT",
    ...
    public static readonly Regex Canon1 = _Canon1();
    public static readonly Regex Canon2 = _Canon2();
    ...
    protected static string ParseFloat32(byte[] data,int pos)
    {
        ...
        var mantissa = ((data[pos + 2] | 0x80) << 16) | (data[pos + 1] << 8) | data[pos];
    ...
    [GeneratedRegex(@"^([\-])*0\.")]
    private static partial Regex _Canon1();
    [GeneratedRegex(@"\.0$")]
    private static partial Regex _Canon2();
}
